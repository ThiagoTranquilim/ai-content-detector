...
function exibirResultado(resultado) {
    ...
    if (classePrevista) {
        classePrevista.innerHTML = `<span class="${classe === 'IA' ? 'classe-ia' : 'classe-humano'}">${classe === 'IA' ? 'Generated by Artificial Intelligence' : 'Created by Human'}</span>`;
    }
            ...
            chatMessages.innerHTML = `
                <div class="message bot">
                    <div class="message-content">
                        Hello! I am the AI detection assistant. To begin, click "Start":
                    </div>
                </div>
            `;
        }
